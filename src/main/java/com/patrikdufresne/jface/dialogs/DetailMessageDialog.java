...
public class DetailMessageDialog extends MessageDialogWithToggle {
     ...
     */
    public static MessageDialogWithToggle openDetailError(Shell parent, String title, String message, String shortDetail) {
        return openDetailError(parent, title, message, shortDetail, (String) null);
    }
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailError(Shell parent, String title, String message, String shortDetail, String longDetail) {
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailError(Shell parent, String title, String message, String shortDetail, Throwable longDetail) {
        StringWriter sw = new StringWriter();
        longDetail.printStackTrace(new PrintWriter(sw));
        return openDetailError(parent, title, message, shortDetail, sw.toString());
    }
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailErrorWithToggle(
            Shell parent,
            String title,
            String message,
            String shortDetail,
     ...
     *         <code>getToggleState()</code>
     */
    public static DetailMessageDialog openDetailInformation(Shell parent, String title, String message, String shortDetail) {
        return openDetailInformation(parent, title, message, shortDetail, (String) null);
    }
     ...
     *         <code>getToggleState()</code>
     */
    public static DetailMessageDialog openDetailInformation(Shell parent, String title, String message, String shortDetail, String longDetail) {
        DetailMessageDialog dialog = new DetailMessageDialog(parent, title,
        // Sets window's icon
                null,
                message,
     ...
     *         <code>getToggleState()</code>
     */
    public static DetailMessageDialog openDetailInformation(Shell parent, String title, String message, String shortDetail, Throwable longDetail) {
        StringWriter sw = new StringWriter();
        longDetail.printStackTrace(new PrintWriter(sw));
        return openDetailInformation(parent, title, message, shortDetail, sw.toString());
    }
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailInformationWithToggle(
            Shell parent,
            String title,
            String message,
            String shortDetail,
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailOkCancelConfirm(Shell parent, String title, String message, String shortDetail, String longDetail) {
        DetailMessageDialog dialog = new DetailMessageDialog(parent, title,
        // Sets window's icon
                null,
                message,
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailOkCancelConfirmWithToggle(
            Shell parent,
            String title,
            String message,
            String shortDetail,
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailWarning(Shell parent, String title, String message, String shortDetail) {
        return openDetailWarning(parent, title, message, shortDetail, (String) null);
    }
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailWarning(Shell parent, String title, String message, String shortDetail, String longDetail) {
        DetailMessageDialog dialog = new DetailMessageDialog(parent, title,
        // Sets window's icon
                null,
                message,
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailWarning(Shell parent, String title, String message, String shortDetail, Throwable longDetail) {
        StringWriter sw = new StringWriter();
        longDetail.printStackTrace(new PrintWriter(sw));
        return openDetailWarning(parent, title, message, shortDetail, sw.toString());
    }
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailWarningWithToggle(
            Shell parent,
            String title,
            String message,
            String shortDetail,
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailYesNoCancelQuestion(Shell parent, String title, String message, String shortDetail, String longDetail) {
        DetailMessageDialog dialog = new DetailMessageDialog(parent, title,
        // Sets window's icon
                null,
                message,
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailYesNoCancelQuestionWithToggle(
            Shell parent,
            String title,
            String message,
            String shortDetail,
     ...
     *         <code>getToggleState()</code>
     */
    public static DetailMessageDialog openDetailYesNoQuestion(Shell parent, String title, String message, String shortDetail, String longDetail) {
        DetailMessageDialog dialog = new DetailMessageDialog(parent, title,
        // Sets window's icon
                // TODO Anything related to planimod should be moved to
                // MessageUtils.
                null,
                message,
                shortDetail,
     ...
     *         <code>getToggleState()</code>
     */
    public static MessageDialogWithToggle openDetailYesNoQuestionWithToggle(
            Shell parent,
            String title,
            String message,
            String shortDetail,
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.jface.dialogs.MessageDialogWithToggle#createDialogArea(org.eclipse.swt.widgets.Composite)
     */
    @Override
    protected Control createDialogArea(Composite parent) {
        ...
        if (!this.toogleButtonEnabled) {
            getToggleButton().setVisible(false);
            GridData data = new GridData(SWT.FILL, SWT.FILL, false, false);
            data.heightHint = 0;
            data.widthHint = 0;
            getToggleButton().setLayoutData(data);
        }
        return control;
    }
