...
public class ActionMenuManager extends MenuManager {
	...
	public ActionMenuManager(String id, IAction defaultActionHandler,
			boolean retargetLastAction) {
		this(defaultActionHandler.getText(), defaultActionHandler
				.getImageDescriptor(), id, defaultActionHandler,
				retargetLastAction);
	}
	 ...
	 *            whether to retarget the last action or not
	 */
	protected ActionMenuManager(String text, ImageDescriptor image, String id,
			IAction defaultActionHandler, boolean retargetLastAction) {
		super(text, image, id);
