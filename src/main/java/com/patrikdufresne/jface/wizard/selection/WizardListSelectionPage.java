 ...
 * 
 */
public class WizardListSelectionPage extends WizardSelectionPage implements
	...
	static {
		JFaceResources.getImageRegistry().put(
				ICON_CATEGORY_16,
				ImageDescriptor.createFromFile(WizardListSelectionPage.class,
						IMAGES_PATH + "folder-16.png"));
	}
	 ...
	 */
	public WizardListSelectionPage(String title, String emptyMessage,
			String message, Collection<IWizardNodeFactory> factories) {
		super("wizardListSelectionPage"); //$NON-NLS-1$
		if (title == null || message == null || factories == null
				|| factories.size() == 0) {
