...
public class PreferenceConverter {
     ...
     */
    public static void setDefault(IPreferenceStore prefstore, String key, int[] array) {
     ...
     *            the new default value for the preference
     */
    public static void setDefault(IPreferenceStore prefstore, String key, String[] array) {
     ...
     */
    public static void setValue(IPreferenceStore prefstore, String key, int[] array) {
     ...
     *            the new current value of the preference
     */
    public static void setValue(IPreferenceStore prefstore, String key, String[] array) {
        prefstore.setValue(key + ".size", array.length); //$NON-NLS-1$
        for (int i = 0; i < array.length; i++) {
            prefstore.setValue(key + "." + Integer.toString(i), array[i]); //$NON-NLS-1$
        }
