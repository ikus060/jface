...
public class DetailMessageDialog extends MessageDialogWithToggle {
	...
	public static MessageDialogWithToggle openDetailError(Shell parent,
		...
		// Sets window's icon
				null, message, shortDetail, longDetail,
	...
	public static MessageDialogWithToggle openDetailErrorWithToggle(
			...
			String longDetail, String toggleMessage, boolean toggleState,
	 ...
	 *         <code>getToggleState()</code>
	 */
	public static MessageDialogWithToggle openDetailOkCancelConfirm(
			Shell parent, String title, String message, String shortDetail,
			String longDetail) {
		DetailMessageDialog dialog = new DetailMessageDialog(parent, title,
		// Sets window's icon
	 ...
	 *         <code>getToggleState()</code>
	 */
	public static MessageDialogWithToggle openDetailYesNoCancelQuestion(
			Shell parent, String title, String message, String shortDetail,
			String longDetail) {
		DetailMessageDialog dialog = new DetailMessageDialog(parent, title,
		// Sets window's icon
	 ...
	 *         <code>getToggleState()</code>
	 */
	public static DetailMessageDialog openDetailYesNoQuestion(Shell parent,
			String title, String message, String shortDetail, String longDetail) {
